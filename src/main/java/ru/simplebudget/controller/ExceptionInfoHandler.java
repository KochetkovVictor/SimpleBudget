...
import ru.simplebudget.utils.exceptions.ErrorInfo;
import ru.simplebudget.utils.exceptions.NotFoundException;
...
public class ExceptionInfoHandler {
    ...
    @ResponseStatus(value = HttpStatus.METHOD_NOT_ALLOWED)  // 422
